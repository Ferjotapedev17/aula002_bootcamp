...
#area_raio = float(input("Digite o raio do circulo: "))
#area_do_circulo = math.pi * area_raio ** 2
...
#data_do_usuário = input("Insira a data no formato dd/mm/aaaa: ")
#lista_de_dia_mes_ano = data_do_usuário.split("/")
